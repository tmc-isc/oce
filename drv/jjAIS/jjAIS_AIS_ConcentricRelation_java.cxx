...
#include <jjAIS_AIS_ConcentricRelation.h>
...
JNIEXPORT void JNICALL Java_jjAIS_AIS_1ConcentricRelation_AIS_1ConcentricRelation_1Create_10 (JNIEnv *env, jobject theobj, jobject aFShape, jobject aSShape, jobject aPlane)
{
...
Handle(AIS_ConcentricRelation)* theret = new Handle(AIS_ConcentricRelation);
*theret = new AIS_ConcentricRelation(*the_aFShape,*the_aSShape,the_aPlane);
...
JNIEXPORT void JNICALL Java_jjAIS_AIS_1ConcentricRelation_AIS_1ConcentricRelation_1Compute_14 (JNIEnv *env, jobject theobj, jobject aProjector, jobject aTrsf, jobject aPresentation)
{
...
Handle(AIS_ConcentricRelation) the_this = *((Handle(AIS_ConcentricRelation)*) jcas_GetHandle(env,theobj));
