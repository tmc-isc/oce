...
import jjAIS.AIS_DisplayMode;
import jjAIS.Prs3d_LineAspect;
import jjAIS.AIS_TypeOfIso;
...
import jjAIS.SelectMgr_IndexedMapOfOwner;
...
import jjAIS.SelectMgr_SelectionManager;
import jjAIS.PrsMgr_PresentationManager3d;
import jjAIS.StdSelect_ViewerSelector3d;


public class AIS_InteractiveContext extends jjAIS.MMgt_TShared {
...
native public final void SetAutoActivateSelection(boolean Auto);
native public final boolean GetAutoActivateSelection();
...
native public final void RemoveAll(boolean updateviewer);
...
native public final void SetPolygonOffsets(AIS_InteractiveObject anObj,int aMode,double aFactor,double aUnits,boolean updateviewer);
native public final boolean HasPolygonOffsets(AIS_InteractiveObject anObj);
native public final void PolygonOffsets(AIS_InteractiveObject anObj,Standard_Integer aMode,Standard_Real aFactor,Standard_Real aUnits);
...
final public short ShiftSelect(TColgp_Array1OfPnt2d Polyline,V3d_View aView,boolean updateviewer) {
   return AIS_InteractiveContext_ShiftSelect_2(Polyline,aView,updateviewer);
}

private final native short AIS_InteractiveContext_ShiftSelect_2(TColgp_Array1OfPnt2d Polyline,V3d_View aView,boolean updateviewer);

final public short ShiftSelect(int XPMin,int YPMin,int XPMax,int YPMax,V3d_View aView,boolean updateviewer) {
   return AIS_InteractiveContext_ShiftSelect_3(XPMin,YPMin,XPMax,YPMax,aView,updateviewer);
}

private final native short AIS_InteractiveContext_ShiftSelect_3(int XPMin,int YPMin,int XPMax,int YPMax,V3d_View aView,boolean updateviewer);

native public final void SetToHilightSelected(boolean toHilight);
native public final boolean ToHilightSelected();
...
native public final void EntityOwners(SelectMgr_IndexedMapOfOwner theOwners,AIS_InteractiveObject theIObj,int theMode);
...
native public final void SetZDetection(boolean aStatus);
native public final boolean ZDetection();
...
final public void ErasedObjects(AIS_ListOfInteractive theListOfIO) {
    AIS_InteractiveContext_ErasedObjects_1(theListOfIO);
}

private final native void AIS_InteractiveContext_ErasedObjects_1(AIS_ListOfInteractive theListOfIO);

final public void ErasedObjects(short WhichKind,int WhichSignature,AIS_ListOfInteractive theListOfIO) {
    AIS_InteractiveContext_ErasedObjects_2(WhichKind,WhichSignature,theListOfIO);
}

private final native void AIS_InteractiveContext_ErasedObjects_2(short WhichKind,int WhichSignature,AIS_ListOfInteractive theListOfIO);

final public void ObjectsByDisplayStatus(short theStatus,AIS_ListOfInteractive theListOfIO) {
    AIS_InteractiveContext_ObjectsByDisplayStatus_1(theStatus,theListOfIO);
}

private final native void AIS_InteractiveContext_ObjectsByDisplayStatus_1(short theStatus,AIS_ListOfInteractive theListOfIO);

final public void ObjectsByDisplayStatus(short WhichKind,int WhichSignature,short theStatus,AIS_ListOfInteractive theListOfIO) {
    AIS_InteractiveContext_ObjectsByDisplayStatus_2(WhichKind,WhichSignature,theStatus,theListOfIO);
}

private final native void AIS_InteractiveContext_ObjectsByDisplayStatus_2(short WhichKind,int WhichSignature,short theStatus,AIS_ListOfInteractive theListOfIO);
...
native public final AIS_LocalContext LocalContext();
...
native public final StdSelect_ViewerSelector3d LocalSelector();
