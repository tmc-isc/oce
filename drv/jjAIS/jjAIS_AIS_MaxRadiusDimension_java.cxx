...
#include <jjAIS_AIS_MaxRadiusDimension.h>
...
JNIEXPORT void JNICALL Java_jjAIS_AIS_1MaxRadiusDimension_AIS_1MaxRadiusDimension_1Create_11 (JNIEnv *env, jobject theobj, jobject aShape, jdouble aVal, jobject aText)
{
...
Handle(AIS_MaxRadiusDimension)* theret = new Handle(AIS_MaxRadiusDimension);
*theret = new AIS_MaxRadiusDimension(*the_aShape,(Standard_Real) aVal,*the_aText);
...
JNIEXPORT void JNICALL Java_jjAIS_AIS_1MaxRadiusDimension_AIS_1MaxRadiusDimension_1Create_12 (JNIEnv *env, jobject theobj, jobject aShape, jdouble aVal, jobject aText, jobject aPosition, jshort aSymbolPrs, jdouble anArrowSize)
{
...
Handle(AIS_MaxRadiusDimension)* theret = new Handle(AIS_MaxRadiusDimension);
*theret = new AIS_MaxRadiusDimension(*the_aShape,(Standard_Real) aVal,*the_aText,*the_aPosition,(DsgPrs_ArrowSide) aSymbolPrs,(Standard_Real) anArrowSize);
jcas_SetHandle(env,theobj,theret);
...
JNIEXPORT void JNICALL Java_jjAIS_AIS_1MaxRadiusDimension_AIS_1MaxRadiusDimension_1Compute_14 (JNIEnv *env, jobject theobj, jobject aProjector, jobject aTrsf, jobject aPresentation)
{
...
Handle(AIS_MaxRadiusDimension) the_this = *((Handle(AIS_MaxRadiusDimension)*) jcas_GetHandle(env,theobj));
